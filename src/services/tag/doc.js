...
export async function get(params) {
    return request(`/api/tag/${params.doc_id}/draft`)
}

export async function setLock(params){
    return request(`/api/tag/${params.doc_id}/lock`,{ 
        method: 'PUT'
    })
}
...
export async function update(params){
    ...
    return request(`/api/tag/${doc_id}/content`,{ 
        method: 'PUT',
        data:other
    })
}
...
export async function rollback(params){
    const { doc_id , ...other} = params
    return request(`/api/tag/${doc_id}/rollback`,{ 
        method: 'PUT',
        data:other
    })
}
...
export async function publish(params){
    const { doc_id , ...other} = params
    return request(`/api/tag/${doc_id}/publish`,{ 
        method: 'PUT',
        data:other
    })
}