...
class Viewer extends React.PureComponent {
    ...
    renderContent() {
        ...
        return <React.Fragment>
            { this.props.renderVersion(version) }
        </React.Fragment>
    } 
    ...
    renderDiff() {
        ...
        if (!diff) return null
        return <div>
            { this.props.renderDiff(diff.current, diff.target) }
        </div>
    } 
    // 渲染文档版本基本信息
    ...
    render() {
        ...
        return <div className={styles["doc-history"]}>
            ...
            <div className={styles["doc-history-body"]}>
                ...
                <div className={styles["version-viewer-footer"]}>
                    ...
                    <div className={styles["actions"]}>
                        ...
                        <Button type="primary" onClick={() => { this.revert(this.state.currentVersionId) }} disabled={!this.canRevert()}>恢复此版本</Button>
                    </div>
                </div>
            </div>
        </div>
