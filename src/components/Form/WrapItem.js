...
class WrapFormItem extends Component {
    ...
    startInterval = (time) => {
        ...
        const { onStop , onStep } = this.props
    ...
    render(){
        ...
        const getFormItem = (label,extra) => {
            return (
                ...
                hasFeedback={this.props.form.isFieldValidating(name) || (!this.props.form.getFieldError(name) && !this.state.item.isFocus) ? hasFeedback === undefined || hasFeedback : false}
                >
        ...
        return getFormItem(label,extra)
    }
}
